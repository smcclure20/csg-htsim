...
for i in {1..10}
do
    ./htsim_constcca -end 0 -tm ./connection_matrices/alltoall_128n_2MB.cm -nodes 128 -strat ecmp -hostlb plb -plbecn 4 -of ../../results/opt-4-2/400g/plb/opt-ata-128n-2MB-400g-plb4_06-${i}.csv -ratecoef 0.9 -linkspeed 400000
done
