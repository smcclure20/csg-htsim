...
for i in {1..10}
do
    ./htsim_constcca -end 0 -tm ./connection_matrices/alltoall_128n_2MB.cm -nodes 128 -strat ecmp -hostlb spray -of ../../results/opt-4-2/reliability/default/sfd3/opt-ata-128n-2MB-sf0d3-spray-${i}.csv -ratecoef 0.9 -subflows 0 -dup 3
done

    for i in {1..10}
do
    ./htsim_constcca -end 0 -tm ./connection_matrices/alltoall_128n_2MB.cm -nodes 128 -strat ecmp -hostlb spray -of ../../results/opt-4-2/reliability/default/sfd6/opt-ata-128n-2MB-sf0d6-spray-${i}.csv -ratecoef 0.9 -subflows 0 -dup 6
done
