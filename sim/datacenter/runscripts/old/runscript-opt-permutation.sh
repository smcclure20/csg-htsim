...
# Base case
./htsim_constcca -end 0 -tm ./connection_matrices/perm_128n_1280c_2MB.cm -nodes 128 -strat ecmp -hostlb spray -of ../../results/opt-3-25/opt-perm1280c-128n-2MB-trimrts-spray-flows.csv -ratecoef 0.9 -trim -rts
./htsim_constcca -end 0 -tm ./connection_matrices/perm_128n_1280c_2MB.cm -nodes 128 -strat ecmp -hostlb spray -of ../../results/opt-3-25/opt-perm1280c-128n-2MB-trim-spray-flows.csv -ratecoef 0.9 -trim
./htsim_constcca -end 0 -tm ./connection_matrices/perm_128n_1280c_2MB.cm -nodes 128 -strat ecmp -hostlb spray -of ../../results/opt-3-25/opt-perm1280c-128n-2MB-spray-flows.csv -ratecoef 0.9 
./htsim_consterase -end 0 -tm ./connection_matrices/perm_128n_1280c_2MB.cm -nodes 128 -strat ecmp -hostlb spray -of ../../results/opt-3-25/opt-perm1280c-128n-2MB-erase-spray-flows.csv -ratecoef 0.9
...
# ./htsim_constcca -end 0 -tm ./connection_matrices/perm_128n_12800c_2MB.cm -nodes 128 -strat ecmp -hostlb spray -of ../../results/opt-3-25/opt-perm12800c-128n-2MB-trimrts-spray-flows.csv -ratecoef 0.9 -trim -rts
# ./htsim_constcca -end 0 -tm ./connection_matrices/perm_128n_12800c_2MB.cm -nodes 128 -strat ecmp -hostlb spray -of ../../results/opt-3-25/opt-perm12800c-128n-2MB-trim-spray-flows.csv -ratecoef 0.9 -trim
# # ./htsim_constcca -end 0 -tm ./connection_matrices/perm_128n_12800c_2MB.cm -nodes 128 -strat ecmp -hostlb spray -of ../../results/opt-3-25/opt-perm12800c-128n-2MB-spray-flows.csv -ratecoef 0.9 
# ./htsim_consterase -end 0 -tm ./connection_matrices/perm_128n_12800c_2MB.cm -nodes 128 -strat ecmp -hostlb spray -of ../../results/opt-3-25/opt-perm12800c-128n-2MB-erase-spray-flows.csv -ratecoef 0.9
